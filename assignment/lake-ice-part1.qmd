...
The data is slightly left-skewed; it has more low outliers than high outliers, however, it still follows a bell-shaped curve with its peak near zero, with another exception at around -5. I would say its generally meeting the normal distribution assumption.
...
1 week, which I believe is meaningful. That's only a couple decades before a whole month earlier, which is undoubtedly a significant environmental change, impacting any phenological timeline like crops, transport, hibernation, or dormancy. 
